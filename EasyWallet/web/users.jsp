...
<%@page import="admin.model.UserDao"%>
	...
	<td>
		...
		<td>
                    ...
                    <select  class="styledselect" name="opt">
                        <option value="edit">Account ID</option>			
		...
		<!--  start product-table ..................................................................................... -->
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">Account ID</a></th>
					...
					<th class="table-header-options line-left"><a href="">Options</a></th>
                                ...
                                <%
                                    ...
                                    ArrayList al=hd.getUser(x,y,did); %>
				...
				<tr class="alternate-row">
                                    ...
                                    <%   User hs=(User)al.get(a);  
                                       request.setAttribute("User", hs);
                                       q=hs.getCount();
                                       int w=hs.getAid();
                                       Account ac=hd.getAccount(w);
                                 %>
                                 
                                 <td><input name="chk"  type="checkbox"/></td>
                                 <td><%=hs.getFirstname()%>&nbsp;<%=hs.getLastname()%></td>
					<td><%=ac.getAccount_id()%></td>
					<td><a><%=hs.getEmail()%></a></td>
					<td><%=ac.getLogin()%></td>				
					<td class="options-width">
                                        <a href="UserServlet?aid=<%=ac.getAid()%>&opt=edit" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="UserServlet?aid=<%=ac.getAid()%>&opt=delete" title="Delete" class="icon-2 info-tooltip"></a>                                    
