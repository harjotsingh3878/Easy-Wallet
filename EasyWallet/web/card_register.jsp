...
<div id="page-heading"><h1>REGISTER CARD</h1></div>
...
<tr>
	...
	<!--  start step-holder -->
		...
		<!-- start id-form -->
                <form action="card_register_edit.jsp" method="post">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                    <tr style="height:50px"></tr><tr></tr>
		
                <tr>
			<th valign="top">Card Type:</th>
                        <td><input type="text" class="inp-form" name="type"/></td>
			
		</tr>
		<tr>
			<th valign="top">Card Number:</th>
                        <td><input type="text" class="inp-form" name="card"/></td>
			<td>
			...
			<th valign="top">Card Holder Name:</th>
                        <td><input type="text" class="inp-form" name="holder"/></td>
			<td>
