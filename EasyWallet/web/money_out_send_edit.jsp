...
<tr>
	...
	<!--  start step-holder -->
        ...
        <tr class="dark"><td><div class="">SEND MONEY TO</div></td><td><input name="msg_to" type="text" class="input"  value="${param.send}" id="user" readonly="true"/></td></tr>
        <tr class="light"><td><div class="">MESSAGE</div></td><td><input name="msg" type="text" class="input1"  value="${param.msg}"  id="pass" readonly="true"/></td></tr>
        ...
        <input name="msg_from" type="hidden" value="<%=user.getEmail()%>" />
            </tbody>
