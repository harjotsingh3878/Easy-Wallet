...
<tr>
	...
	<div id="login-inner">
		...
		<tr>
			<th>Old Password</th>
			<td><input type="password"  class="login-inp" name="uname"/></td>
		</tr>
		<tr>
			<th>New Password</th>
		...
		<tr>
			<th>Confirm Password</th>
                        <td><input type="password" value="************"  onfocus="this.value=''" class="login-inp" id="csec" name="upass"/></td>
                         <td class="error-inner" id="2">Password ID do not match</td>
                </tr>
		<tr>
			<th></th>
                        <td><input type="submit" class="submit-login" value="pass" name="action" /></td>
