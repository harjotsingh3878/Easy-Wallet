     ...
     <div style="float: left;margin-left: 100px">       
		...
		<tr>
			...
			<th valign="top">Card Number:</th>
                        <td><input type="text" class="inp-form" id="element" name="chk" value="<%=hs.getCard()%>" readonly="true"/></td>
			
		</tr>
                <tr>
			<th valign="top">Card Number:</th>
                        <td><input type="text" class="inp-form" id="element" name="chk" value="<%=hs.getHolder()%>" readonly="true"/></td>
			
		</tr>
                <tr>
			<th valign="top">Card Number:</th>
                        <td><input type="text" class="inp-form" id="element" name="chk" value="<%=hs.getBank()%>" readonly="true"/></td>
			...
			<th valign="top">Card Number:</th>
                ...
                <tr>
			<th valign="top">Card Number:</th>
                        <td><input type="text" class="inp-form" id="element" name="chk" value="<%=hs.getDte()%>" readonly="true"/></td>
