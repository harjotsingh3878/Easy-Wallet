	...
	<script src="js/jquery-1.10.2.js"></script>
                <script type="text/javascript">
                    ...
                    function conform()
                    {
                        ...
                        var y=document.forms["myform"]["csec"].value;
                        if(x!=y)
                            {
                                $('#2').show();
                                return false;
	...
	<div id="login-inner">
            <form action="SettingsServlet" method="post" onsubmit="return conform()" id="myform">
                <table  border="0" cellpadding="0" cellspacing="0">
                    <input type="hidden" name="aid" value="<%=user.getAid()%>"
		<tr>
			<th>Old Security ID</th>
			<td><input type="text"  class="login-inp" name="uname"/></td>
		</tr>
		<tr>
			<th>New Security ID</th>
                        <td><input type="password" value="************"  onfocus="this.value=''" class="login-inp" id="sec" name="upass"/></td>
		</tr>
		<tr>
			<th>Confirm Security ID</th>
                        <td><input type="password" value="************"  onfocus="this.value=''" class="login-inp" id="csec" name="upass1"/></td>
                         <td class="error-inner" id="2">Security ID do not match</td>
                </tr>
		<tr>
			<th></th>
                        <td><input type="submit" value="security" name="action" class="submit-login"  /></td>
