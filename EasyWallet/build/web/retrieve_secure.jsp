...
<div id="page-heading"><h1>CHANGE SECURITY ID</h1></div>
                     <!--  start step-holder -->
...
<tr>
	...
	<script src="js/jquery-1.10.2.js"></script>
                <script type="text/javascript">
                    ...
                    function conform()
                    {
                        ...
                        var z=document.forms["myform"]["uname1"].value;
                        var a=document.forms["myform"]["upass1"].value;
	...
	<div id="login-inner">
            <form action="SettingsServlet" method="post" onsubmit="return conform()" id="myform">
                <table  border="0" cellpadding="0" cellspacing="0">
		<tr>
			<th>Security Question No.1</th>
                        <td><input type="text"  class="login-inp" name="uname" value="<%=user.getSecure1()%>"/></td>
		</tr>
		<tr>
			<th>Answer</th>
                        <td><input type="text"  class="login-inp" id="sec" name="upass"/></td>
		</tr>
		<tr>
			<th>Security Question No.2</th>
                        <td><input type="text"  class="login-inp" id="csec" name="uname1" value="<%=user.getSecure2()%>"/></td>
                         
                </tr>
                <tr>
			<th>Answer</th>
                        <td><input type="text" class="login-inp" id="csec" name="upass1"/></td>
                         
                </tr>
		<tr>
			<th></th>
                        <td><input type="submit" class="submit-login" value="retrieve" name="action" /></td>
