...
<tr>
	...
	<!--  start step-holder -->
        ...
        <tr class="light"><td width="223"><div class="">AMOUNT (in Rs)</div></td><td width="265"><input name="amount" type="text" class="input1"  value="${param.amount}" id="fname" readonly="true" /></td></tr>
        <tr class="dark"><td><div class="">BANK NAME</div></td><td><input name="bank" type="text" class="input"  value="${param.bank}" id="user" readonly="true"/></td></tr>
        <tr class="light"><td><div class="">CARD NUMBER</div></td><td><input name="cards" type="text" class="input1"  value="${param.cards}"  id="pass" readonly="true"/></td></tr>
        <tr class="dark"><td><div class="">CARD HOLDER NAME</div></td><td><input name="hname" type="text" class="input" value="${param.hname}" id="conform" readonly="true"/></td></tr>
        <tr class="light"><td><div class="">EXPIRATION DATE</div></td><td><input name="expiry" type="text" class="input1"  value="${param.day}/${param.month}/${param.year}"  id="pass" readonly="true"/></td></tr>
        <tr class="dark"><td><div class="">CVV CODE</div></td><td><input name="cvv" type="text" class="input" value="${param.cvv}" id="conform" readonly="true"/></td></tr>
        <tr class="light"><td><div class="">TRANSACTION ID</div></td><td><input name="tran" type="text" class="input1"  value="${param.tran}"  id="pass" readonly="true"/></td></tr>
        <tr class="dark"><td><div class="">SECURITY NUMBER</div></td><td><input name="sid" type="password" class="input" value="${param.sid}" id="conform" readonly="true"/></td></tr>
        <input name="did" type="hidden" value="${sessionScope.did}" />
            </tbody>
